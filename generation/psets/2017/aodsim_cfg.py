...
# Output definition
outputname = str('file:.oO[OUTPUTFILE]Oo.')
...
outputCommands.extend([
    ...
    'drop recoTracks_generalTracks_*_*',
    'drop *_particleFlow_*_*',
    'drop *_particleFlowTmpPtrs_*_*',
    'drop *_particleFlowPtrs_*_*',
    'drop *_trackRefsForJets_*_*',
    'drop TrackingRecHitsOwned_*_*_*',
    'drop recoVertex_*_*_*',
